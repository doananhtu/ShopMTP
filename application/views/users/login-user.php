			...
			<div class="col-xs-12 col-sm-4 col-md-4">
				<div class="bg-login">
					<?php echo form_open(base_url().'index.php/users/login'); ?> 
						<h1 style="margin-left: 10px; margin-top: 40px; font-variant:small-caps;">ログイン</h1>
						...
						<input type="checkbox" name="forget" style="margin: 10px;">Remember password<br>
						<input type="submit" value="ログイン" class="submit">
					</form>						
					
					<a href="<?php echo base_url() ?>index.php/users/register" style="text-decoration: none;"><div style="margin-left:10px;color:red;width:93%;text-align:center;">アカウントがある？</div></a>
					<a href="<?php echo base_url() ?>index.php/users/register"><button class="registor">サインアップ</button></a>
