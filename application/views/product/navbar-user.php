                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo base_url()?>index.php/cart" style="color:#03AC9A">
                                <i class="fa fa-cart-arrow-down"></i> Xem Giỏ Hàng <?php if(count($this->cart->contents())>0) echo '<i class="badge">'.count($this->cart->contents()).'</i>';?></a>
                            </li>
