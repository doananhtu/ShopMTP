            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo base_url()?>index.php/cart">
                        ...
                        カート <?php if(count($this->cart->contents())>0) echo '<sup class="badge">'.count($this->cart->contents()).'</sup>';?></a></li>
                </ul>
                ...
                <script type="text/javascript">
                    $(document).ready(function(){
                        $("button#search").click(function(){
                            ...
                            var url = '<?php echo base_url()?>index.php/users/search?str='+str;
                            window.location = url;
                        });
                    });
                </script>
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url()?>index.php/users/infoUser" style="color:#7D7D7D"><i class="fa fa-info-circle" style="color:#F71E4C"></i> 個人情報</a></li>
                            <li><a href="<?php echo base_url()?>/index.php/users/changePass" style="color:#7D7D7D"><i class="fa fa-lock"></i> パスワードを変更する</a></li>
                            <li><a href="<?php echo base_url()?>index.php/users/transHis" style="color:#03AC9A">
                                <i class="fa fa-cart-arrow-down"></i> 代金</a>
                            </li>
                            <li role="separator" class="divider"></li>
                            <li><a href="<?php echo base_url()?>index.php/users/logout" style="color:#7D7D7D"><i class="fa fa-sign-out" style="color:green"></i> ログアウト</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
